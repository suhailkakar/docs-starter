...
To get some testnet tokens, please visit the [Turin Faucet](https://turin.faucet.tac.build/)
...
Once the transaction is confirmed, you will see the contract address in the terminal. You can verify the contract on the [Turin Block Explorer](https://turin.explorer.tac.build/)
