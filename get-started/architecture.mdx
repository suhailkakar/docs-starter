...
2. TAC Adapter: A decentralized message routing layer on both TON and EVM sides secured by a set of sequencers and TON LSTs with proof of stake
...
The TAC Adapter connects TON with TAC EVM as a set of smart contracts handling:
...
- Message formatting for the TAC Adapter
- Asset handling
...
- DApp proxy creates a message for the TAC Adapter
- TON assets are locked in the TAC Adapter
