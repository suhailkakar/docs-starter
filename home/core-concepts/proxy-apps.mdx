---
title: Proxy Apps
description: "Learn about proxy applications in TAC"
icon: layers
---
...
<Info>
  TAC team can help you build and deploy the contracts for your projects.
...
<Warning>
  Everything on TON side is handled by TAC SDK. You don't need to build your own
  proxy on TON side.
</Warning>
