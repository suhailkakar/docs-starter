...
Complete your TAC SDK mastery with the final section:
...
<CardGroup cols={2}>
  ...
  <Card title="Changelog" icon="file-text" href="/build/sdk/changelog">
    Stay updated with SDK changes and version updates
  </Card>
</CardGroup>
