...
With comprehensive tracking in place, explore advanced SDK features:

<CardGroup cols={2}>
  <Card
    title="Asset Bridging"
    icon="arrow-left-right"
    href="/build/sdk/asset-bridging"
  >
    Learn advanced asset bridging strategies and mechanics
  </Card>
  <Card
    title="Error Handling"
    icon="shield-alert"
    href="/build/sdk/error-handling"
  >
