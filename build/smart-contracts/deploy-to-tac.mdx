...
<Frame>
  <img src="/images/faucet/faucet-example.png" alt="TAC Testnet Faucet" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Build a Proxy Contract" icon="bridge" href="/developers/build/smart-contracts/build-a-proxy">
    Learn how to create a proxy contract that enables TON users to interact with your EVM contract
  </Card>
  <Card title="Integrate with TAC SDK" icon="code" href="/developers/build/sdk/introduction">
