...
<CardGroup cols={2}>
  <Card
    ...
    icon="coins"
    href="/core-concepts/token-operations"
  >
    Learn how different token types are validated and processed
  </Card>
  <Card title="Native Tokens" icon="star" href="/core-concepts/native-tokens">
    Explore validation specific to native TON and TAC tokens
  </Card>
</CardGroup>
