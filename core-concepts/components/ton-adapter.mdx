---
title: TON Adapter
description: "The decentralized messaging system that securely connects TON and TAC EVM through sequencer consensus"
---
...
The security and reliability of the TON Adapter depends on a decentralized network of sequencers that validate and process cross-chain messages.
...
<Tabs>
  <Tab title="Latency">
    ...
    While slower than single-chain transactions, this latency is acceptable for most application use cases and
    significantly faster than traditional bridge operations.
  </Tab>
