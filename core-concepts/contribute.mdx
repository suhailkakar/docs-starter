...
2. TAC Adapter: a decentralized message routing system to connect the TON network and the TAC EVM network
...
4. Becoming a TAC Adapter Sequencer. There are a limited number of seats to become part of the sequencers, refer to [this page](validator-2) to join the sequencing and earn fees from TON restaking.
