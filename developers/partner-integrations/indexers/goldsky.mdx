# Indexing with Goldsky on TAC

Goldsky is Web3’s realtime data platform, giving TAC developers access to world-class data infrastructure specifically optimized for building powerful onchain applications within the TAC ecosystem.
...
- **TAC Developer-Friendly Tools**: Easily integrate and iterate your apps within the TAC ecosystem without getting bogged down by complex data engineering.
